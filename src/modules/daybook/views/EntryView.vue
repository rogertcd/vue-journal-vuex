<template>
  ...
  <FloatButton :faicon="faicon" />

  <img src="https://techcrunch.com/wp-content/uploads/2022/07/v8P8WLP6R7HDHUUykHJvfFkJrzz.jpg?w=1390&crop=1"
  alt="entry-picture"
       class="img-thumbnail"
  />
</template>
...
export default {
  name: "EntryView",
  components: {
    FloatButton: defineAsyncComponent(() => import('@/modules/daybook/components/Fab'))
  },
  data () {
    return {
      faicon: 'fa-save'
